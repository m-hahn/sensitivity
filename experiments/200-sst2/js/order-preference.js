...
const jqueryScript = document.createElement('script')
	...
	while(1) {
	   ...
	   for(j=0; j<alreadyDone.length; j++) {
        ...
        jqueryScript.src = '../../../block-certificates/process/output/process_SST2_PMLM_1billion.py_'+exp.conditionIndex+'.js'
        console.log( '../../../block-certificates/process/output/process_SST2_PMLM_1billion.py_'+exp.conditionIndex+'.js');
...
function initAfterGettingData() {
         ...
         stimuliContext = _.shuffle(stimuli.slice(0, 50)); //_.sample(stimuli, 30);
