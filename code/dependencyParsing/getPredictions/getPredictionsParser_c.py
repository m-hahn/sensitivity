...
with open("/u/scr/mhahn/PRETRAINED/parsing/en_ewt-ud-dev_alternatives_c.txt", "r") as inFile:
 try:
   while True:
...
with open("/u/scr/mhahn/PRETRAINED/parsing/en_ewt-ud-dev_alternatives_c_predictions.txt", "w") as outFile:
