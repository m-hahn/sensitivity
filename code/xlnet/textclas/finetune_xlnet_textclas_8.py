...
# ~/python-py37-mhahn finetune_xlnet_textclas_8.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=cr/mr/subj/trec/mpqa
...
sentences = data_dev[::]
with open(f"/u/scr/mhahn/PRETRAINED/textclas/{args.dataset}_alternatives_finetuned.txt", "w") as outFile:
