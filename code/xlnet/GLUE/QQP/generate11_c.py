...
# ~/python-py37-mhahn generate11_c.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=QQP
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_c.tsv", "w") as outFile:
