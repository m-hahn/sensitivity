...
# ~/python-py37-mhahn generate11.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=QQP
...
sentences = []
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/test.tsv", "r") as inFile:
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/test_alternatives.tsv", "w") as outFile:
...
#    quit()
  ...
  #  quit()
    ...
    BATCH_SIZE = 128 # this is because otherwise there is OOM
