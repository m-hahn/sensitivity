...
# ~/python-py37-mhahn generate12_d.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=RTE
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_d.tsv", "w", encoding="utf-8") as outFile:
  for prompt_text1, prompt_text2 in sentences:
    dataPointCounter += 1
    if dataPointCounter < 35: # initial datapoints covered by c version
       continue
    # Different models need different input formatting and/or extra arguments
