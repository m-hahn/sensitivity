...
# ~/python-py37-mhahn generate6_d.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased
...
with open("/u/scr/mhahn/PRETRAINED/WSC/val_alternatives_d.txt", "w") as outFile:
  for prompt_text in sentences[75:]:
