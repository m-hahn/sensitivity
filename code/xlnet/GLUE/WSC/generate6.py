...
# ~/python-py37-mhahn generate6.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased
...
with open("/u/scr/mhahn/PRETRAINED/WSC/val_alternatives.txt", "w") as outFile:
