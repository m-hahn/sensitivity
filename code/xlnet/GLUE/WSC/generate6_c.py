...
# ~/python-py37-mhahn generate6_c.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased
...
with open("/u/scr/mhahn/PRETRAINED/WSC/val_alternatives_c.txt", "w") as outFile:
