...
# ~/python-py37-mhahn generate9_c.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=CoLA
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/CoLA/dev_alternatives_c.tsv", "w") as outFile:
