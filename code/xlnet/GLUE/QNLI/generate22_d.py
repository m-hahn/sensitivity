...
groups = ["c"]
for group in groups:
 with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/QNLI/dev_alternatives_{group}.tsv", "r") as inFile:
...
# ~/python-py37-mhahn generate22_d.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=QNLI
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_d.tsv", "w", encoding="utf-8") as outFile:
