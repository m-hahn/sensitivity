...
# ~/python-py37-mhahn generate10_b2.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=SST2
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/SST-2/dev_alternatives_respectWordBoundaries.tsv", "w") as outFile:
