...
# ~/python-py37-mhahn finetune_xlnet_sst2_10_c_sentBreak_new_large_sample_modelMode.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=SST2
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/SST-2/dev_alternatives_c_sentBreak_new_finetuned_large_modelMode.tsv", "w") as outFile:
