...
# ~/python-py37-mhahn finetune_xlnet_sst2_10.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=SST2
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/SST-2/dev_alternatives_c_finetuned.tsv", "w") as outFile:
