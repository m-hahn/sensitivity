...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/MNLI/dev_alternatives_c.tsv", "r") as inFile:
...
# ~/python-py37-mhahn generate18_d.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=MNLI
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_d.tsv", "w") as outFile:
