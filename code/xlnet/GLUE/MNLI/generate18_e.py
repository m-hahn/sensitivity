...
# ~/python-py37-mhahn generate18_e.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=MNLI
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_e.tsv", "w") as outFile:
