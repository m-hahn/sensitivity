...
# ~/python-py37-mhahn generate18_g.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=MNLI
...
with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/{args.dataset}/dev_alternatives_g.tsv", "w") as outFile:
  for prompt_text1, prompt_text2 in sentences[900:]:
    # Different models need different input formatting and/or extra arguments
