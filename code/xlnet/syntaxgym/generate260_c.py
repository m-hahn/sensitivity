...
# ~/python-py37-mhahn generate24_c.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased --dataset=SyntaxGym_260
...
assert args.dataset == "SyntaxGym_260"
