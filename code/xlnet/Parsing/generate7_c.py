...
# ~/python-py37-mhahn generate7_c.py --model_type="XLNet" --model_name_or_path=xlnet-large-cased
...
with open("/u/scr/mhahn/PRETRAINED/parsing/en_ewt-ud-dev_alternatives_c.txt", "w") as outFile:
