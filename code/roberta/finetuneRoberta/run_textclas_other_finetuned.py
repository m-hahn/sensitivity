...
for group in groups:
 try:
  with open(f"/u/scr/mhahn/PRETRAINED/textclas/{args.task_name}_alternatives_finetuned{group}.txt", "r") as inFile:
...
#        quit()
    ...
    print(predictions)
    outPath = f"/u/scr/mhahn/PRETRAINED/textclas/{args.task_name}_alternatives_finetuned_Predictions.txt"
