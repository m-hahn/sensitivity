...
with open('/u/scr/mhahn/PRETRAINED/GLUE/glue_data/QQP/dev_alternatives_LSTMpredictions.tsv', "w") as outFile:
 for group in [""]:
   with open(f"/u/scr/mhahn/PRETRAINED/GLUE/glue_data/QQP/dev_alternatives{group}_predictions_fairseq.tsv", "r") as inFile:
