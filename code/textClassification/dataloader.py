# https://github.com/asappresearch/sru/blob/master/classification/dataloader.py
...
def read_MR(path, seed=1234, clean=True):
    file_path = os.path.join(path, "rt-polarity.all")
    data, labels = read_corpus(file_path, encoding='latin-1', clean=clean)
    random.seed(seed)
